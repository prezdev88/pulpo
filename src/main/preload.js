...
contextBridge.exposeInMainWorld('api', {
  ...
  unstageFiles: (repoPath, files) => ipcRenderer.invoke('git:unstageFiles', repoPath, files),
    stashChanges: (repoPath, message) => ipcRenderer.invoke('git:stashChanges', repoPath, message),
    listStashes: (repoPath) => ipcRenderer.invoke('git:listStashes', repoPath),
    popStash: (repoPath, stashId) => ipcRenderer.invoke('git:popStash', repoPath, stashId),
    applyStash: (repoPath, stashId) => ipcRenderer.invoke('git:applyStash', repoPath, stashId),
    dropStash: (repoPath, stashId) => ipcRenderer.invoke('git:dropStash', repoPath, stashId),
